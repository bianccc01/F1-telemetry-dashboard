window.BrakeChart = {
    create() {
        ...
        // Prepara i dati
        const allData = BrakeChart.prepareData();
        ...
        // Scale
        const scales = BrakeChart.createScales(allData, width, height);

        // Assi
        BrakeChart.createAxes(g, scales, width, height, margin);

        // Linee
        BrakeChart.createLines(g, allData, scales);
